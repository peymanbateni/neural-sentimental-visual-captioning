from torch import nn, cat, zeros, cuda
...
"""
!!!
Attention and DecoderWithAttention Networks and the training procedure are all modified from:
...
class DecoderWithAttention(nn.Module):
    ...
    def forward(self, encoder_out, encoded_captions, caption_lengths):
        ...
        predictions = zeros((batch_size, max(decode_lengths), vocab_size)).to(device)
        alphas = zeros((batch_size, max(decode_lengths), num_pixels)).to(device)
